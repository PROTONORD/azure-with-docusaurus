...
const config = {
  ...
  url: 'https://wonderful-flower-0c4b8b003.5.azurestaticapps.net',
  ...
  projectName: 'azure-with-docusaurus', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/PROTONORD/azure-with-docusaurus/tree/main/',
        },
        blog: false,
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/PROTONORD/azure-with-docusaurus',
            label: 'GitHub',
            position: 'right',
          },
        ],
